      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white px-4 py-2 rounded-lg hover:from-emerald-600 hover:to-emerald-700 transition-all">
              Get Started
            </button>
          </div>
      ...
      {isOpen && (
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 bg-zinc-900 border-b border-gray-800">
            ...
            <button className="w-full text-left px-3 py-2 text-emerald-400 hover:text-emerald-300">
              Get Started
            </button>
          </div>
        </motion.div>
